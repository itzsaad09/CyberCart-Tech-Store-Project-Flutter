...
import 'package:cybercart/models/product_model.dart'; // Assume path
...
final List<Product> viralProducts = [
  const Product(
    ...
    price: 3500.0,
    imageUrl: 'assets/products/watch1.png', // Placeholder
    category: 'Coolers',
  ),
  const Product(
    id: 'V002',
    ...
    price: 399.0,
    imageUrl: 'assets/products/headset1.png', // Placeholder
    category: 'Headsets',
  ),
  const Product(
    id: 'V003',
    ...
    price: 3999.0,
    imageUrl: 'assets/products/airpods1.png', // Placeholder
    category: 'Earbuds',
  ),
  const Product(
    id: 'V004',
    ...
    price: 999.0,
    imageUrl: 'assets/products/headphone1.png', // Placeholder
    category: 'Headphones',
  ),
];
